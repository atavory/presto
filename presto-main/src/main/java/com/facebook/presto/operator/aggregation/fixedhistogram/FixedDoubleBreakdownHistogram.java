...
public class FixedDoubleBreakdownHistogram
        ...
        implements Iterable<FixedDoubleBreakdownHistogram.Bin>
{
    ...
    public class Bin
    {
        ...
        public Bin(double left, double right, Map<Double, Long> breakdown)
        {
            this.left = left;
            this.right = right;
    ...
    public Iterator<Bin> iterator()
    {
        ...
        return new Iterator<Bin>()
        {
            ...
            public Bin next()
            {
                ...
                return new Bin(baseValue.left, baseValue.right, breakdowns.get(baseValue.index));
            }
