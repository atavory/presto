...
public class SampleEntropyStateJacknifeStrategy
        extends SampleEntropyStateHistogramBasedStrategy
{
    public SampleEntropyStateJacknifeStrategy(long bucketCount, double min, double max)
    {
        super(new FixedDoubleBreakdownHistogram((int) bucketCount, min, max));
    }

    protected SampleEntropyStateJacknifeStrategy(SampleEntropyStateJacknifeStrategy other)
    {
        super(new FixedDoubleBreakdownHistogram(other.getBreakdownHistogram()));
    }

    public SampleEntropyStateJacknifeStrategy(SliceInput input)
    {
    ...
    public void mergeWith(SampleEntropyStateStrategy other)
    {
        getBreakdownHistogram()
                .mergeWith(((SampleEntropyStateJacknifeStrategy) other).getBreakdownHistogram());
    }
    ...
    {
        return new SampleEntropyStateJacknifeStrategy(this);
    }
}
