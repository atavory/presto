...
public abstract class TestSampleEntropyStateHistogramBasedStrategy
{
    ...
    public TestSampleEntropyStateHistogramBasedStrategy(StrategyCreator strategyCreator)
    {
    ...
    public void negativeWeight()
    {
        ...
        final Random random = new Random(13);
        try {
            strategy.validateParams(200, 0.0, 10.0, -1);
            fail("Expected exception");
        }
